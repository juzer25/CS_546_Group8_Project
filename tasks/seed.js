...
async function main(){
    ...
    try{
        const user3 = await users.createUser('Mehul','Mehul@123','Mehul','Savaliya','mehulsavaliya@gmail.com','1999/09/10','254-777-8755','25 Liberty','Jersey City','NJ','07307');
    }
    catch(e){
        console.log(e);
    }
    ...
    try{
        const appointment1 = await appointmentRequestData.createappointment('kirtan', 'savanikirtan311@gmail.com', '2021-12-13', 'add new plan', 'New Appointment');
    }
    catch(e){
        console.log(e);
    }
    try{
        const appointment2 = await appointmentRequestData.createappointment('kirtan', 'savanikirtan311@gmail.com', '2021-12-13', 'close plan', 'Others');
    }
    catch(e){
        console.log(e);
    }
    try{
        const appointment3 = await appointmentRequestData.createappointment('Juzer', 'juzerbhagat@gmail.com', '2021-12-19', 'Technical Issue', 'Technical Issue');
    }
    catch(e){
        console.log(e);
    }
